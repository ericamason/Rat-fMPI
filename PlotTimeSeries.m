function [] = PlotTimeSeries(DataIn_conv, DriftTerms_All_RS, Yhat_RS, ConstReg_RS, CNRMap, ROI, TimeSec, CapniaTrigSeries_delay, conv_kernel_size, dx, dy, x, y, coreg_flag, coreg, bed_position, rows, a)
